...
export const BentoGridItem = ({
  ...
  const leftLists = ["ReactJS", "NextJS", "HTML","CSS"];
  const rightLists = ["Java", "NodeJS"];
  ...
  const handleCopy = () => {
    const text = "abdullahkamilbaig@gmail.com";
            ...
            <div className="flex gap-4 items-center justify-center">
              {[
                ...
                },
                {
                  ...
                  link: "https://www.facebook.com/profile.php?id=100007981969484",
                },
                {
